...
function displayCart() {
  ...
  for(var i in cartArray) {
    output += "<tr>"
      ...
      + "<td><div class='input-group'><button style='padding: 2px 6px'  class='minus-item input-group-addon btn btn-primary' data-name=" + cartArray[i].name + ">-</button>"
      + "<input style='padding: 6px' type='number' class='item-count form-control' data-name='" + cartArray[i].name + "' value='" + cartArray[i].count + "'>"
      + "<button style='padding: 2px 6px'  class='plus-item btn btn-primary input-group-addon' data-name=" + cartArray[i].name + ">+</button></div></td>"
